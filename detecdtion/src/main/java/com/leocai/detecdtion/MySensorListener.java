 ...
 */
public class MySensorListener extends Observable implements SensorEventListener {
    private static final int PEAK_NUM = 15;
    public static final int THREHOLD_ACC = 4;
    private final ShakeBufferView shakeBufferView;
    ...
    public MySensorListener(ShakeBufferView shakeBufferView) {
        this.shakeBufferView = shakeBufferView;
    }
...
//        windowAcc.pop();
    ...
    private void dealBuffer(int peakNum) {
        ...
        peakRoll2();
        shrinkPeak();
        shakeBufferView.postInvalidate();
        setChanged();
        notifyObservers();
    }
